  ...
  const handleNavigate = (path) => {
    ...
    if (blocks.length > 0) {
      ...
      gsap.to(blocks, {
        scaleY: 1,
        duration: 0.8,
        stagger: { each: 0.08, from: 'start', grid: [2, 5], axis: 'x' },
        ease: 'power4.inOut',
        onComplete: () => navigate(path),
      })
    } else {
      // Fallback jika elemen blocks tidak ada di DOM
      gsap.to('.about-page', {
        opacity: 0, duration: 0.6, onComplete: () => navigate(path)
      })
    }
  }
        ...
        <div className="grid-container">
          ...
          <div className="left-column">
            ...
            <div className="btn-container">
              {/* PERBAIKAN DI SINI */}
              <span onClick={() => handleNavigate('/contact')} className="talk-btn" style={{ cursor: 'pointer' }}>
